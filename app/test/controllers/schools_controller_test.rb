...
class SchoolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school" do
    assert_difference('School.count') do
      post schools_url, params: { school: { assistant_dean: @school.assistant_dean, dean: @school.dean} }
    end
  ...
  test "should update school" do
    patch school_url(@school), params: { school: { assistant_dean: @school.assistant_dean, dean: @school.dean} }
